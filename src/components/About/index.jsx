      ...
      <div ref={ref} className="about--grid">
        ...
        <motion.div initial="hidden" animate={controls} variants={opacityVariant} transition={{ duration: 1, delay: 2 }} onAnimationComplete={() => handleComplete()} className="about--detail">
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>Highly motivated software engineer, focus on solving complex issues to ensure a better user experience.  Very competent under stress situations, and work diligently to get any problem solved, on that most efficient time possible.</ScrambleText>
          </p>
        </motion.div>
